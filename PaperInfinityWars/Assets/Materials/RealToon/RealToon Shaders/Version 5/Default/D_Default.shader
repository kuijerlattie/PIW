    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4((v.vertex.xyz + _OutlineOffset.xyz * 0.01) + _OEM*((lerp( _VertexColorRedAffectOutlineWitdh_var, (_VertexColorRedAffectOutlineWitdh_var*node_1229), _OutlineWidthAffectedByViewDistance )*0.01)*_OutlineWidthControl_var.r*lerp(1.0,node_1283,_NoisyOutlineIntensity)),1) );
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
				...
				float attenuation = smoothstep(dlshmin,dlshmax,sha);
				#endif
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
				...
				half dlshmin = lerp(0,0.6,_ShadowHardness);
				half dlshmax = lerp(1,0.6,_ShadowHardness);
				fixed attenuation = smoothstep(dlshmin, dlshmax ,UNITY_SHADOW_ATTENUATION(i, i.posWorld.xyz));
				#endif
